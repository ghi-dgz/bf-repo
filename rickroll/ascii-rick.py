...
# frames borrowed from https://github.com/hugomd/ascii-live/blob/master/frames/rick.go

frames = ["""tfffLfttffffffLLffffttttttttttt1tfffffffffftttttt111111tffffffffftttff
